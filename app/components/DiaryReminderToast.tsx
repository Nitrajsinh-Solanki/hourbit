...
const PERSONAL_PREFIXES = [
  ...
  { text: "Tiny reminder", emoji: "📌" },
  { text: "Pause", emoji: "🫠" },
  { text: "Be honest", emoji: "🫣" },
  { text: "No filters", emoji: "📷" },
  { text: "One sec", emoji: "⏳" },
  { text: "Plot twist", emoji: "🎬" },
  { text: "Live update", emoji: "📡" },
  { text: "Small reality check", emoji: "🧾" },
  { text: "Quick truth", emoji: "🪶" },
  { text: "One real thing", emoji: "🕯️" },

  { text: "One honest line", emoji: "✍️" },
  { text: "Mini check-in", emoji: "🩶" },
  { text: "Inner ping", emoji: "📨" },
  { text: "Mind alert", emoji: "🧩" },
  { text: "Soul check", emoji: "🪞" },
  { text: "Night note", emoji: "🌌" },
  { text: "Before sleep", emoji: "🌘" },
  { text: "One thing", emoji: "📖" },
  { text: "Just saying", emoji: "🌚" },
  { text: "No lie", emoji: "👁️" },

  { text: "You know what", emoji: "🫠" },
  { text: "If we're real", emoji: "🪞" },
  { text: "No performance", emoji: "🎭" },
  { text: "Current status", emoji: "📶" },
  { text: "Human update", emoji: "🛠️" },
  { text: "Memory check", emoji: "💾" },
  { text: "Quick check", emoji: "🔍" },
  { text: "Short truth", emoji: "🪄" },
  { text: "Small check-in", emoji: "📍" },
  { text: "One minute", emoji: "⌛" },

  { text: "Oye", emoji: "⚡" },
  { text: "Dekho", emoji: "📝" },
  { text: "Sun na", emoji: "🌙" },
  { text: "Sun zara", emoji: "🎧" },
  { text: "Sach sach", emoji: "👁️" },
  { text: "Seedhi baat", emoji: "🧷" },
  { text: "Ek baat", emoji: "🪞" },
  { text: "Thoda ruk", emoji: "⏸️" },
  { text: "Aaj ka truth", emoji: "🧠" },
  { text: "Aaj ka mood", emoji: "🌫️" },

  { text: "Aaj ka scene", emoji: "🎭" },
  { text: "Aaj ka mess", emoji: "🫗" },
  { text: "Aaj ka chaos", emoji: "🌪️" },
  { text: "Bas ek sec", emoji: "⏳" },
  { text: "Sach bolu", emoji: "🫀" },
  { text: "No bakwaas", emoji: "🚫" },
  { text: "Sun ek minute", emoji: "⌛" },
  { text: "Ek chhoti si baat", emoji: "📌" },
  { text: "Bas sun", emoji: "🎙️" },
  { text: "Seedha point", emoji: "📍" },

  { text: "Aaj ka update", emoji: "📡" },
  { text: "Dil ka update", emoji: "🫀" },
  { text: "Dimaag alert", emoji: "🧠" },
  { text: "Andar ka scene", emoji: "🌑" },
  { text: "Mood check", emoji: "🩶" },
  { text: "Raat se pehle", emoji: "🌘" },
  { text: "Sone se pehle", emoji: "🛏️" },
  { text: "Ek honest baat", emoji: "✍️" },
  { text: "Aaj ka sach", emoji: "🪶" },
  { text: "No acting", emoji: "🎭" },

  { text: "Sach mein", emoji: "🫣" },
  { text: "Zara soch", emoji: "💭" },
  { text: "Aaj ka haal", emoji: "📶" },
  { text: "Dil se", emoji: "💌" },
  { text: "Dimaag se", emoji: "🧩" },
  { text: "Seedha update", emoji: "🛠️" },
  { text: "Aaj ka note", emoji: "📖" },
  { text: "Bas itna", emoji: "🪄" },
  { text: "Ek line", emoji: "📝" },
  { text: "Thodi sachchai", emoji: "🔍" },
];
