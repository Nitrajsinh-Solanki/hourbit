...
const EXPENSES_NUDGE_MSGS = [
  { headline: "New typing record!", body: "Now if only your wallet kept records too…", emoji: "💸" },
  { headline: "WPM best broken!", body: "Meanwhile your expenses: completely untracked. Impressive.", emoji: "🏆" },
  { headline: "Fingers faster than ever.", body: "Too bad money leaves even faster — untracked.", emoji: "⚡" },
  { headline: "New best! A ninja tracks every move.", body: "Your expenses? Just vibes.", emoji: "🥷" },
  { headline: "Speed: going up.", body: "Savings: unknown. Log it in Expenses.", emoji: "📈" },
  { headline: "Personal record!", body: "You clearly care about precision… just not financially.", emoji: "🎯" },
  { headline: "You type fast enough to log expenses in 3 seconds.", body: "Yet here we are.", emoji: "🔥" },
  { headline: "WPM: historic high.", body: "Bank account awareness: historically low. Fix one?", emoji: "💀" },
  { headline: "Big brain typing energy.", body: "Your budget spreadsheet remains a blank page.", emoji: "🧠" },
  { headline: "New speed unlocked!", body: "Your expense tracker is still at zero entries though.", emoji: "🚀" },
];
